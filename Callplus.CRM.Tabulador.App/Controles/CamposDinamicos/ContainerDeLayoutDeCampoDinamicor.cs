...
using Callplus.CRM.Tabulador.App.CamposDinamicos;
using Callplus.CRM.Tabulador.Dominio.Entidades.LayoutDinamico;
using CallplusUtil.Extensions;

namespace Callplus.CRM.Tabulador.App.Controles.CamposDinamicos
{
    public partial class ContainerDeLayoutDeCamposDinamicos : UserControl
    {
        private const int TotalDeColunas = 12;
        private LayoutDeCampoDinamico _layoutDeCampoDinamico;

        public ContainerDeLayoutDeCamposDinamicos()
        {
            InitializeComponent();
        ...
        {
            //if (CustomTextBox.InvokeRequired)
            //{
            ...
            foreach (Control control in tableLayout.Controls)
            {
                ...
                {
                    control.Invoke(new MethodInvoker(() => (control as CustomTextBox)?.Resetar()));
