...
{
    public partial class ScriptDeFinalizacaoControl : UserControl
    {
        public ScriptDeFinalizacaoControl()
        {
        ...
        public event EventHandler OnFinalizarScript;
        ...
        public void Iniciar(ScriptDeAtendimento script, Campanha campanha)
        {
        ...
        private void Avancar()
        {
            ...
            if (etapaAtualpossuiRespostas)
            {
                ...
                {
                    var proximaEtapa = _respostaSelecionada?.ProximaEtapa;
        ...
        private void CarregarEtapaInicial()
        {
            ...
            bool existeProximaEtapa = _scriptDeAtendimento.EtapaAtual.Respostas.Any(x => x.ProximaEtapa != null);
