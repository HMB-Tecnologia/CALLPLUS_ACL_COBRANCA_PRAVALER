...
namespace Callplus.CRM.Tabulador.App.Operacao
{
	public partial class AtendimentoForm : Form
    {
        ...
        private void ExibirTelaDeOferta(StatusDeOferta statusOferta)
        {
            ...
            {
                OfertaMigracaoPreControleTimForm formMigracao = new OfertaMigracaoPreControleTimForm(_usuario, oferta.Id, _prospectDoAtendimento, _containerDeLayoutDinamico, _discadorConectado, true, true, statusOferta.Id, _campanhaAtual.Id);
                formMigracao.PararTempoEvent += OnPararTempo;
                _pilhaDeJanelas.Push(formMigracao);
                formMigracao.StartPosition = FormStartPosition.CenterScreen;
                formMigracao.ShowDialog();
            ...
            if (oferta.IdTipoDeProduto == 0)
            {
                OfertaRentabilizacaoTimForm formRenta = new OfertaRentabilizacaoTimForm(_usuario, oferta.Id, _prospectDoAtendimento, true, true, statusOferta.Id, _campanhaAtual.Id);
            ...
            if (oferta.IdTipoDeProduto == 1 || oferta.IdTipoDeProduto == 4 || oferta.IdTipoDeProduto == 5)
            {
                ...
                OfertaPortabilidadeMPForm formPortabilidade = new OfertaPortabilidadeMPForm(_usuario, oferta.Id, _prospectDoAtendimento, true, true, _containerDeLayoutDinamico, _discadorConectado, tsTxtLoginHuawei.Text, statusOferta.Id, _campanhaAtual.Id);
                formPortabilidade.PararTempoEvent += OnPararTempo;
                _pilhaDeJanelas.Push(formPortabilidade);
                formPortabilidade.StartPosition = FormStartPosition.CenterScreen;
                formPortabilidade.ShowDialog();
                if (_pilhaDeJanelas.Any())
                    _pilhaDeJanelas.Pop();
            }
            ...
            if (oferta.IdTipoDeProduto == 0)
            {
                OfertaNETPTVForm formNETPTV = new OfertaNETPTVForm(_usuario, oferta.Id, _prospectDoAtendimento, true, true, _containerDeLayoutDinamico, _discadorConectado, statusOferta.Id, _campanhaAtual.Id);
                _pilhaDeJanelas.Push(formNETPTV);
                formNETPTV.StartPosition = FormStartPosition.CenterScreen;
                formNETPTV.ShowDialog();
                if (_pilhaDeJanelas.Any())
                    _pilhaDeJanelas.Pop();
            }
        }
